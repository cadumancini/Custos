 ...
 * @author cemancini
 */
public class ConsExis_GrupoProduto extends javax.swing.JFrame {
    Session conexao;
    private static ConsExis_GrupoProduto instance = null;
    Cad_GrupoProduto janelaPai;
    /**
    ...
    public void alimentarTabela(){
        ...
        try {
            ...
            model = (DefaultTableModel) TblGrupos.getModel();
            ...
            for(GrupoProduto grupo : grupos){
                ...
                String[] linha = new String[]{grupo.getCodigo(), grupo.getDescricao()};
                model.addRow(linha);
            }
            conexao.close();
        } catch(Exception e){
        ...
        resizeColumnWidth(TblGrupos);
        this.setLocationRelativeTo(null); 
    }
    
    public static ConsExis_GrupoProduto getInstance() {
        if (instance == null)
           instance = new ConsExis_GrupoProduto();
      return instance;
    }
    
    public void setJanelaPai(Cad_GrupoProduto pai){
        janelaPai = pai;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsExis_GrupoProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsExis_GrupoProduto().setVisible(true);
            }
        });
    }
